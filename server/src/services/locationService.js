...
export const searchProvinces = async (query) => {
  try {
    const response = await axios.get(`${API_URL}/p/search/?q=${query}`);
    return response.data;
  } catch (error) {
...
export const searchDistricts = async (query, provinceCode) => {
  try {
    const response = await axios.get(`${API_URL}/d/search/?q=${query}&p=${provinceCode}`);
    return response.data;
  } catch (error) {
...
export const searchWards = async (query, districtCode) => {
  try {
    const response = await axios.get(`${API_URL}/w/search/?q=${query}&d=${districtCode}`);
    return response.data;
  } catch (error) {
