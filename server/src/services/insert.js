    ...
    try {
      dataBody.forEach(async (item) => {
        ...
        await db.Overview.create({
          id: overviewId,
          code:
            item?.overview?.content.find((i) => i.name === "Mã tin:")
              ?.content || "",
          area:
            item?.overview?.content.find((i) => i.name === "Khu vực")
              ?.content || "",
          type:
            item?.overview?.content.find((i) => i.name === "Loại tin rao:")
              ?.content || "",
          target:
            item?.overview?.content.find((i) => i.name === "Đối tượng thuê:")
              ?.content || "",
          bonus:
            item?.overview?.content.find((i) => i.name === "Gói tin:")
              ?.content || "",
          created:
